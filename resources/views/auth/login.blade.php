                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-user{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Email"  required autofocus>
                                    ...
                                    @endif
                                    <hr>
                                    <a href="{{url('https://www.gmail.com/login')}}" class="btn btn-google btn-user btn-block">
